...
import { UserAgentState, Web, Invitation, Inviter, Messager, Registerer, RegistererState, RequestPendingError, SessionState, UserAgent } from 'sip.js'
/**
 ...
 * @public
 */
const Transport = Web.Transport
const SessionDescriptionHandler = Web.SessionDescriptionHandler
export class UserAgentCustom {
    ...
    constructor(server, options = {}) {
        ...
        this.logger = this.userAgent.getLogger("sip.UserAgent");
